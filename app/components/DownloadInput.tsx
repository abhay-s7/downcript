...
export default function DownloadInput({ onSubmit }: { onSubmit: (url: string) => void }) {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <label className="block text-sm font-medium text-gray-700 mb-1.5">Video or media URL</label>
